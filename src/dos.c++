...
int main() {
    ...
    #endif
    string input;
    cout << "Android OS DOS Module v1.0.0" << endl;
    ...
    const vector<string> forbidden = { "398", "ltsc", "420", "secup2" };
    ...
    while (true) {
        ...
        if (lcmd == "ver") {
            cout << "Android OS DOS Module v1.0.0" << endl;
            cout << "Copyright (c) November 2025 Beta7Developer. All rights reserved." << endl;
            cout << "Available OSes: Console AndroidOS Build302" << endl;
            continue;
        }
        ...
        if (pos_exe != string::npos) {
            ...
            if (exe_token != "conand.exe" && exe_token != "conand") {
