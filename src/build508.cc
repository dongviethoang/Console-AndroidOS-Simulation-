...
const int version = 508;
const int kernel_version = 35;
...
void bootloader()
{
    ...
    this_thread::sleep_for(chrono::seconds(1));
    cout << "Build 508 (Kernel Version 35)" << endl;
    this_thread::sleep_for(chrono::seconds(1));
...
void update()
{
    cout << "Updating to build: 620" << endl;
...
void powerop() {
    ...
    if (powerinp == "Restart" || powerinp == "restart") {
        ...
        system(R"(taskkill /IM "build508.exe" /F 2>&1)");
